 ...
 * /kpt transfer <user>
 */
class TransferCommand(module: CommandManagerContainer) : CommandManagerContainer by module, KptCommand {
    override val alias: String = "transfer"
    val controller = clanManagementControllers.transferController.create()
